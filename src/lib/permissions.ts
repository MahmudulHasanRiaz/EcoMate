...
const EMPTY_PERMISSIONS: StaffMember['permissions'] = {
    ...
    tasks: CREATE_READ_UPDATE, wholesaleManagement: NO_ACCESS,
...
export const PERMISSIONS: Record<StaffRole, StaffMember['permissions']> = {
    SuperAdmin: withPageAccess('SuperAdmin', {
        ...
        accounting: FULL_ACCESS, marketing: FULL_ACCESS, integrations: FULL_ACCESS, tasks: FULL_ACCESS, wholesaleManagement: NO_ACCESS,
    }),
    ...
    Manager: withPageAccess('Manager', {
        ...
        marketing: READ_ONLY, integrations: FULL_ACCESS, tasks: FULL_ACCESS, wholesaleManagement: FULL_ACCESS,
    }),
    'Modarator Manager': withPageAccess('Modarator Manager', {
        ...
        accounting: { ...CREATE_READ_UPDATE, delete: false }, marketing: NO_ACCESS, integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: READ_ONLY,
    }),
    'Project Manager': withPageAccess('Project Manager', {
        ...
        accounting: READ_ONLY, marketing: READ_ONLY, integrations: READ_ONLY, tasks: CREATE_READ_UPDATE, wholesaleManagement: FULL_ACCESS,
    }),
    'Office Assistant': withPageAccess('Office Assistant', {
        ...
        accounting: NO_ACCESS, marketing: NO_ACCESS, integrations: NO_ACCESS, tasks: NO_ACCESS, wholesaleManagement: NO_ACCESS,
    }),
    Moderator: withPageAccess('Moderator', {
        ...
        accounting: READ_ONLY, marketing: NO_ACCESS, integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: NO_ACCESS,
    }),
    'Packing Assistant': withPageAccess('Packing Assistant', {
        ...
        partners: NO_ACCESS, courierReport: NO_ACCESS, courierManagement: NO_ACCESS, staff: NO_ACCESS,
        settings: NO_ACCESS, analytics: NO_ACCESS, issues: NO_ACCESS, attendance: NO_ACCESS,
        accounting: CREATE_READ_UPDATE, marketing: NO_ACCESS, integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: NO_ACCESS,
    }),
    ...
    'Vendor/Supplier': withPageAccess('Vendor/Supplier', {
        ...
        integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: NO_ACCESS,
    }),
    ...
    'Cutting Master': withPageAccess('Cutting Master', {
        ...
        partners: NO_ACCESS, courierReport: NO_ACCESS, courierManagement: NO_ACCESS, staff: NO_ACCESS,
        settings: NO_ACCESS, analytics: NO_ACCESS, issues: NO_ACCESS, attendance: NO_ACCESS,
        accounting: NO_ACCESS, marketing: NO_ACCESS, integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: NO_ACCESS,
    }),
    'Marketer': withPageAccess('Marketer', {
        ...
        partners: NO_ACCESS, courierReport: NO_ACCESS, courierManagement: NO_ACCESS, staff: NO_ACCESS,
        settings: NO_ACCESS, analytics: NO_ACCESS, issues: NO_ACCESS, attendance: NO_ACCESS,
        accounting: NO_ACCESS, marketing: FULL_ACCESS, integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: NO_ACCESS,
    }),
    'Finance Manager': withPageAccess('Finance Manager', {
        ...
        settings: NO_ACCESS, analytics: NO_ACCESS, issues: NO_ACCESS, attendance: NO_ACCESS,
        accounting: CREATE_READ_UPDATE, marketing: NO_ACCESS, integrations: NO_ACCESS, tasks: CREATE_READ_UPDATE, wholesaleManagement: FULL_ACCESS,
    }),
    'Sales Representative': withPageAccess('Sales Representative', {
